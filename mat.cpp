 ...
 * Author: GOZDEDOGAN
 * 
 * Created on December 10, 2019, 8:33 PM
 */
...
int main()
{
    ...
    pic.readAudioPgm("znano.pgm", "nano");
    pic.print();

    pic.readAudioPgm("mondrianRedBlueAndYellow.pgm", "mondrian");

    pic.readAudioWav("mondrianRedBlueAndYellow.ppm", "mondrian");
    pic.writeImagePgm("zm.pgm", "mondrian.pgm");

    pic.readAudioWav("girlWithPearlEarringSm.ppm", "mondrian");
    pic.writeImagePgm("zg.pgm", "girl with pearl earring color");

//    pic.readAudioPgm("z.pgm", "mondrian").printInt();
}
*/
